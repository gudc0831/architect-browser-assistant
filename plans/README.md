...
Slice 459 lets extension packages use exact SaaS origins through `ARCHITECT_SAAS_ORIGIN`; when unset, builds default to the stable Architect Preview alias, and localhost can be combined with that alias explicitly for development.
